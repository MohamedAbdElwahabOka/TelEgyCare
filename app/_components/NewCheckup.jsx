                        ...
                        {/* <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 bg-gray-100">
                            <div className="bg-white p-4 rounded-lg shadow-md">
                                ...
                                <div className="grid grid-cols-1 gap-4 mt-4 dark:text-black">
                                    <div>
                                        <div className="text-sm text-blue-500 font-bold">Name</div>
                                        <div>Ahmed Hosam Ahmed</div>
                                    </div>
                                    <div>
                                        <div className="text-sm text-blue-500 font-bold">ID</div>
                                        <div>#302088823</div>
                                    </div>
                                    <div>
                                        <div className="text-sm text-blue-500 font-bold">Blood Type</div>
                                        <div>B+</div>
                                    </div>
                                    <div>
                                        <div className="text-sm text-blue-500 font-bold">Age</div>
                                        <div>25 yrs</div>
                                    </div>
                                    <div>
                                        <div className="text-sm text-blue-500 font-bold ">Gender</div>
                                        <div>Male</div>
                                    </div>
                                </div>
                            </div>
...
//         <p className="text-blue-500 font-bold">Upload New Medical Prescription</p>
//         </div>
//         <div className="grid grid-cols-1 md:grid-cols-1 gap-4 py-5">
//         <div className="space-y-2">
//             <label className="text-sm text-black" htmlFor="prescription">
//             Add Prescription
//             </label>
//             <input
//             className="w-full border  border-gray-400 rounded-md bg-gray-100 p-3 text-black"
//             id="prescription"
//             placeholder="Enter prescription details"
//             type="text"
//             required
...
//         </div>
//         <div className="space-y-2">
//             <label className="text-sm text-black" htmlFor="files">
//             Upload Files (optional)
//             </label>
//             <input className="w-full border  border-gray-400 rounded-md bg-gray-100 p-2 text-gray-400" id="files" multiple type="file" option />
//         </div>
//         </div>
//         <div className="space-y-2 mt-4">
//         <label className="text-sm text-black" htmlFor="specialization">
//             Specialization
//         </label>
//         <select className="w-full border  border-gray-400 rounded-md bg-gray-100 p-3 text-black" id="specialization" required>
//             <option value="cardiology">Cardiology</option>
//             <option value="dermatology">Dermatology</option>
//             <option value="gastroenterology">Gastroenterology</option>
//             <option value="orthopedics">Orthopedics</option>
...
//      <button type="submit" className="flex justify-center py-3 px-8 border border-transparent rounded-md shadow-sm text-xl font-medium text-white bg-blue-700 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mb-4">
//         Create
//      </button>
//     </div> 
