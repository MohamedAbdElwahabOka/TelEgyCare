function To_lab() {
    return (
    <div>
      <h3 className="text-lg font-semibold text-gray-700 mr-10 mb-10">Send To Lab </h3>
        <div className=" bg-white rounded-lg border shadow-md p-4">
          <div className="mb-3">
            <h5 className="text-lg font-semibold">Alfa Lab</h5>
            <p className="text-sm text-gray-500 ml-7">patient id</p>
            <hr className="w-100 ml-1 mt-2" />
          </div>
